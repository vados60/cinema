...
class CinemasControllerTest < ActionController::TestCase
  ...
  test "should create cinema" do
    assert_difference('Cinema.count') do
      post :create, cinema: { address: @cinema.address, description: @cinema.description, name: @cinema.name }
    end
  ...
  test "should update cinema" do
    put :update, id: @cinema, cinema: { address: @cinema.address, description: @cinema.description, name: @cinema.name }
    assert_redirected_to cinema_path(assigns(:cinema))
  end
