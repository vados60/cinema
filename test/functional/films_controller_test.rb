...
class FilmsControllerTest < ActionController::TestCase
  ...
  test "should create film" do
    assert_difference('Film.count') do
      post :create, film: { budget: @film.budget, country: @film.country, name: @film.name, year: @film.year }
    end
  ...
  test "should update film" do
    put :update, id: @film, film: { budget: @film.budget, country: @film.country, name: @film.name, year: @film.year }
    assert_redirected_to film_path(assigns(:film))
  end
